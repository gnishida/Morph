...
BFSProp::BFSProp(const char* filename1, const char* filename2) {
	/*
...
void BFSProp::draw(QPainter* painter, int offset, float scale) {
...
void BFSProp::drawGraph(QPainter *painter, RoadGraph *roads, QColor col, int offset, float scale) {
...
void BFSProp::drawRelation(QPainter *painter, RoadGraph *roads1, QMap<RoadVertexDesc, RoadVertexDesc>* correspondence, RoadGraph *roads2, int offset, float scale) {
...
void BFSProp::selectSequence(int selected) {
	this->selected = selected;
}

void BFSProp::clearSequence() {
